...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-LZOUYSYJ.js").then((m4) => m4);
...
var routes = [
  { path: "login", loadComponent: () => import("./chunk-UG2O5TGS.js").then((m4) => m4.LoginComponent) },
  ...
  { path: "unauthorized", loadComponent: () => import("./chunk-3FEFBNGG.js").then((m4) => m4.UnauthorizedComponent) },
  {
    path: "",
    canActivate: [authGuard, contextGuard("admin"), roleGuard(["ADMIN", "SINDICO", "CONSELHO"])],
    loadComponent: () => import("./chunk-3T5DEWYL.js").then((m4) => m4.ShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-FPZNGNP7.js").then((m4) => m4.DashboardComponent) },
      { path: "entregas", loadComponent: () => import("./chunk-SGUVQ7R7.js").then((m4) => m4.AdminDeliveriesComponent) },
      { path: "ocorrencias", loadComponent: () => import("./chunk-B7ZSDHJC.js").then((m4) => m4.AdminOccurrencesComponent) },
      { path: "ocorrencias/:id", loadComponent: () => import("./chunk-UT2UGSNG.js").then((m4) => m4.AdminOccurrenceDetailComponent) },
      { path: "reservas", loadComponent: () => import("./chunk-WU57Y2TY.js").then((m4) => m4.AdminReservationsComponent) },
      { path: "usuarios", loadComponent: () => import("./chunk-56YVOR3E.js").then((m4) => m4.AdminUsersComponent) },
      { path: "plano", loadComponent: () => import("./chunk-DGXRN547.js").then((m4) => m4.AdminBillingComponent) }
    ]
  },
