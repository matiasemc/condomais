...
var SectionHeaderComponent = class _SectionHeaderComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SectionHeaderComponent, selectors: [["cm-section-header"]], inputs: { title: [1, "title"], eyebrow: [1, "eyebrow"] }, ngContentSelectors: _c05, decls: 5, vars: 2, consts: [[1, "section-header"], [1, "section-header__eyebrow"], [1, "section-header__title"]], template: function SectionHeaderComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
        \u0275\u0275domElementStart(0, "div", 0);
...
//# sourceMappingURL=chunk-OBMUP4XE.js.map
