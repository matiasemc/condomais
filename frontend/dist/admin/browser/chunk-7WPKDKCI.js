...
function b(e, t, n = /* @__PURE__ */ new WeakSet()) {
  ...
  for (u = f; u-- !== 0; ) if (T = R2[u], !b(e[T], t[T], n)) return false;
  return true;
}
function y(e, t) {
  return b(e, t);
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T, css: j } = m2, O = v(m2, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M } = d, z2 = v(d, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v(u, ["dark"]), g2 = M || {}, { dark: te2 } = g2, re2 = v(g2, ["dark"]), K = s(O) ? this._toVariables({ [y2]: h(h({}, O), z2) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h(h({}, L), re2) }, r) : {}, X2 = s(V) ? this._toVariables({ [y2]: h(h({}, V), te2) }, r) : {}, [G2, U] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A2.declarations) != null ? x : "", A2.tokens || []], [H, W2] = [(p2 = X2.declarations) != null ? p2 : "", X2.tokens || []], q = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
    l2 = `${q}${Z}`, o = [.../* @__PURE__ */ new Set([...U, ...I, ...W2])], c3 = m(j, { dt: E });
  }
  ...
  let a2 = function(l2, o = {}, c3 = []) {
    ...
    Object.entries(l2).forEach(([m2, d]) => {
      ...
      i(d) ? n(d, u, g2) : (i2[u] || (i2[u] = { paths: [], computed: (f, x = {}, p2 = []) => {
        ...
        if (f && f !== "none") for (let y2 = 0; y2 < i2[u].paths.length; y2++) {
          ...
          if (R2.scheme === f) return R2.computed(f, x.binding, p2);
        }
        return i2[u].paths.map((y2) => y2.computed(y2.scheme, x[y2.scheme], p2));
  ...
  if (s(t)) {
    ...
    if (s3 !== "style") {
      ...
      t = r === "dark" ? c3.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l2, d, t)), m2), "") : C2(l2 != null ? l2 : ":root,:host", t);
    }
    if (o) {
...
//# sourceMappingURL=chunk-7WPKDKCI.js.map
