...
// apps/admin/src/app/features/unauthorized/unauthorized.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UnauthorizedComponent, [{
    ...
    args: [{
      ...
      standalone: true,
      imports: [RouterLink],
      template: '<div style="text-align:center;padding:60px"><h2>Acesso negado</h2><a routerLink="/login">Voltar</a></div>'
    }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UnauthorizedComponent, { className: "UnauthorizedComponent", filePath: "apps/admin/src/app/features/unauthorized/unauthorized.component.ts", lineNumber: 5 });
})();
export {
  UnauthorizedComponent
};
//# sourceMappingURL=chunk-6KMI5QQU.js.map
