...
// apps/admin/src/app/features/login/login.component.ts
...
var LoginComponent = class _LoginComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["cm-login"]], decls: 9, vars: 5, consts: [[1, "w"], [1, "c"], [1, "e"], ["type", "email", "placeholder", "E-mail", 3, "ngModelChange", "ngModel"], ["type", "password", "placeholder", "Senha", 3, "ngModelChange", "ngModel"], [3, "click", "disabled"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1");
        \u0275\u0275text(3, "Admin");
        \u0275\u0275elementEnd();
        \u0275\u0275template(4, LoginComponent_Conditional_4_Template, 2, 1, "p", 2);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    type: Component,
    args: [{ selector: "cm-login", standalone: true, changeDetection: ChangeDetectionStrategy.OnPush, imports: [FormsModule], template: `<div class='w'><div class='c'><h1>Admin</h1>@if(state.error()){<p class='e'>{{state.error()}}</p>}<input type='email' [(ngModel)]='email' placeholder='E-mail'/><input type='password' [(ngModel)]='password' placeholder='Senha'/><button (click)='login()' [disabled]='state.isLoading()'>{{state.isLoading()?'Aguarde\u2026':'Entrar'}}</button></div></div>`, styles: ["/* angular:styles/component:css;088d89c13dbb0917e3322e7d1ed20c4836ad282d737134857cb13a5ec4ef6a4d;C:/Users/Matiasemc/OneDrive/Documentos/git/Condomais/frontend/apps/admin/src/app/features/login/login.component.ts */\n.w {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-height: 100vh;\n}\n.c {\n  background: #fff;\n  padding: 40px;\n  border-radius: 12px;\n  display: flex;\n  flex-direction: column;\n  gap: 14px;\n  min-width: 300px;\n}\ninput {\n  padding: 10px 14px;\n  border: 1.5px solid #ddd;\n  border-radius: 8px;\n  font-size: 15px;\n}\nbutton {\n  padding: 12px;\n  background: #2d6a4f;\n  color: #fff;\n  border: none;\n  border-radius: 8px;\n  cursor: pointer;\n}\n.e {\n  color: #c0392b;\n  font-size: 13px;\n  margin: 0;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "apps/admin/src/app/features/login/login.component.ts", lineNumber: 9 });
})();
export {
  LoginComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-JFPDUOEL.js.map
