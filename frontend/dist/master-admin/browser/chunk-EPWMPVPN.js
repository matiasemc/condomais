...
var DomHandler = class _DomHandler {
  ...
  static matches(element, selector) {
    ...
    var f2 = p4["matches"] || p4.webkitMatchesSelector || p4["mozMatchesSelector"] || p4["msMatchesSelector"] || function(s3) {
  ...
  static getViewport() {
    let win = window, d2 = document, e = d2.documentElement, g2 = d2.getElementsByTagName("body")[0], w3 = win.innerWidth || e.clientWidth || g2.clientWidth, h2 = win.innerHeight || e.clientHeight || g2.clientHeight;
...
var p3 = (t2, n) => {
  ...
  if (T) for (var e of T(n)) V.call(n, e) && D2(t2, e, n[e]);
  return t2;
};
var N2 = (t2, n, e) => new Promise((o, m3) => {
  ...
  }, f2 = (r) => r.done ? o(r.value) : Promise.resolve(r.value).then(i2, M2);
...
function A(t2, n) {
  let e = window.getComputedStyle(t2), o = (l3) => {
    let c3 = e[`${l3}Delay`], h2 = e[`${l3}Duration`];
    return [c3.split(", ").map(oe), h2.split(", ").map(oe)];
  }, [m3, i2] = o(v2), [M2, f2] = o(E), r = Math.max(...i2.map((l3, c3) => l3 + m3[c3])), u2 = Math.max(...f2.map((l3, c3) => l3 + M2[c3])), a2, s3 = 0, d2 = 0;
  return n === v2 ? r > 0 && (a2 = v2, s3 = r, d2 = i2.length) : n === E ? u2 > 0 && (a2 = E, s3 = u2, d2 = f2.length) : (s3 = Math.max(r, u2), a2 = s3 > 0 ? r > u2 ? v2 : E : void 0, d2 = a2 ? a2 === v2 ? i2.length : f2.length : 0), { type: a2, timeout: s3, count: d2 };
}
function $2(t2, n) {
...
function tt(t2, n) {
  ...
  let e = {}, o = false, m3 = {}, i2 = null, M2 = {}, f2 = (a2) => {
    if (Object.assign(e, k3(a2, U2)), !e.enter && !e.leave) throw new Error("Enter or leave must be true.");
    M2 = W2(e), o = H(e), m3 = L(e), i2 = null;
  }, r = (a2) => N2(null, null, function* () {
    i2 == null || i2();
    let { onBefore: s3, onStart: d2, onAfter: l3, onCancelled: c3 } = M2[a2] || {}, h2 = { element: t2 };
    if (o) {
      s3 == null || s3(h2), d2 == null || d2(h2), l3 == null || l3(h2);
      return;
    }
    let { from: g2, active: y3, to: P2 } = m3[a2] || {};
    return S2(t2, e.autoHeight, e.autoWidth), s3 == null || s3(h2), W(t2, g2), W(t2, y3), t2.offsetHeight, P(t2, g2), W(t2, P2), d2 == null || d2(h2), new Promise((b2) => {
      let C3 = $2(e.duration, a2), x3 = () => {
        P(t2, [P2, y3]), i2 = null;
      }, R2 = () => {
        x3(), l3 == null || l3(h2), b2();
      };
...
var z2 = 0;
function G(t2, n, e, o) {
  let m3 = t2._motionEndId = ++z2, i2 = () => {
    m3 === t2._motionEndId && o();
  };
  if (e != null) return setTimeout(i2, e);
  let { type: M2, timeout: f2, count: r } = A(t2, n);
  if (!M2) {
    o();
    return;
  }
  let u2 = M2 + "end", a2 = 0, s3 = () => {
...
var Overlay = class _Overlay extends BaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Overlay_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c012, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
...
var Scroller = class _Scroller extends BaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c013, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.contentTemplate = _t.first);
...
function Select_ng_template_9_p_scroller_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(9, _c014, ctx_r2.scrollHeight));
...
function Select_ng_template_9_ng_template_8_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(8, _c014, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("optionGroup"));
...
function Select_ng_template_9_ng_template_8_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(5, _c014, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("emptyMessage"));
    \u0275\u0275advance();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function SelectItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("id", ctx.id)("pBind", ctx.getPTOptions())("ngStyle", \u0275\u0275pureFunction1(17, _c014, (ctx.scrollerOptions == null ? null : ctx.scrollerOptions.itemSize) + "px"));
...
//# sourceMappingURL=chunk-EPWMPVPN.js.map
