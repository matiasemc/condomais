...
var DashboardComponent = class _DashboardComponent {
  constructor() {
    this.dashboardService = inject(PlatformDashboardService);
    this.stats = signal(null, ...ngDevMode ? [{ debugName: "stats" }] : (
      /* istanbul ignore next */
      []
    ));
    this.recentTenants = signal([], ...ngDevMode ? [{ debugName: "recentTenants" }] : (
      /* istanbul ignore next */
      []
    ));
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      try {
        const dashboard = yield this.dashboardService.getDashboard();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DashboardComponent, selectors: [["cm-dashboard"]], decls: 47, vars: 10, consts: [[1, "page"], [1, "page__header"], [1, "page__title"], [1, "metrics"], [1, "metric", "metric--blue"], [1, "metric__value"], [1, "metric__label"], [1, "metric__sub"], [1, "metric", "metric--green"], [1, "metric", "metric--amber"], [1, "metric"], [1, "metric", "metric--red"], [1, "section"], [1, "section__header"], [1, "section__title"], ["routerLink", "/tenants", 1, "section__link"], [1, "hint"], [1, "tenant-row"], [1, "tenant-row__body"], [1, "tenant-row__name"], [1, "tenant-row__meta"], [1, "tenant-row__right"], [1, "badge"], [1, "plan-chip"]], template: function DashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(44, "Ver todos");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(45, DashboardComponent_Conditional_45_Template, 2, 0, "p", 16)(46, DashboardComponent_Conditional_46_Template, 3, 1);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        let tmp_0_0;
        ...
        let tmp_7_0;
        \u0275\u0275advance(7);
        \u0275\u0275textInterpolate(((tmp_0_0 = ctx.stats()) == null ? null : tmp_0_0.total_tenants) ?? "\u2014");
        \u0275\u0275advance(4);
        ...
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(((tmp_2_0 = ctx.stats()) == null ? null : tmp_2_0.total_users) ?? "\u2014");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(((tmp_3_0 = ctx.stats()) == null ? null : tmp_3_0.total_deliveries) ?? "\u2014");
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1("", (tmp_4_0 = ctx.stats()) == null ? null : tmp_4_0.pending_deliveries, " pendentes");
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate(((tmp_5_0 = ctx.stats()) == null ? null : tmp_5_0.total_occurrences) ?? "\u2014");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(((tmp_6_0 = ctx.stats()) == null ? null : tmp_6_0.total_reservations) ?? "\u2014");
        \u0275\u0275advance(5);
        \u0275\u0275textInterpolate(((tmp_7_0 = ctx.stats()) == null ? null : tmp_7_0.tenants_suspended) ?? "\u2014");
        \u0275\u0275advance(9);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DashboardComponent, { className: "DashboardComponent", filePath: "apps/master-admin/src/app/features/dashboard/dashboard.component.ts", lineNumber: 102 });
})();
export {
  DashboardComponent
};
//# sourceMappingURL=chunk-FBTK4VZ5.js.map
