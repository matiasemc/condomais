...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-RUVVFQSB.js").then((m) => m);
...
var routes = [
  { path: "login", loadComponent: () => import("./chunk-IAY7YYNS.js").then((m) => m.LoginComponent) },
  { path: "unauthorized", loadComponent: () => import("./chunk-PBXDE6HH.js").then((m) => m.UnauthorizedComponent) },
  {
    path: "",
    canActivate: [masterAdminGuard],
    loadComponent: () => import("./chunk-75YVUS75.js").then((m) => m.ShellComponent),
    children: [
      { path: "", redirectTo: "dashboard", pathMatch: "full" },
      { path: "dashboard", loadComponent: () => import("./chunk-SEWUTXVK.js").then((m) => m.DashboardComponent) },
      { path: "tenants", loadComponent: () => import("./chunk-CCOP3BNK.js").then((m) => m.TenantsComponent) },
      { path: "users", loadComponent: () => import("./chunk-6BPMZE2J.js").then((m) => m.UsersComponent) },
      { path: "plans", loadComponent: () => import("./chunk-TCD52XHW.js").then((m) => m.PlansComponent) },
