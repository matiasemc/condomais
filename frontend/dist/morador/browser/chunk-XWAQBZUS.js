...
var GoogleIntegrationsComponent = class _GoogleIntegrationsComponent {
  constructor() {
    ...
    this.connected = signal(false, ...ngDevMode ? [{ debugName: "connected" }] : (
      /* istanbul ignore next */
      []
    ));
    this.calendar = signal(true, ...ngDevMode ? [{ debugName: "calendar" }] : (
      /* istanbul ignore next */
      []
    ));
    this.emailDelivery = signal(true, ...ngDevMode ? [{ debugName: "emailDelivery" }] : (
      /* istanbul ignore next */
      []
    ));
    this.emailReservation = signal(true, ...ngDevMode ? [{ debugName: "emailReservation" }] : (
      /* istanbul ignore next */
      []
    ));
  }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _GoogleIntegrationsComponent, selectors: [["cm-google-integrations"]], decls: 18, vars: 4, consts: [[1, "page"], [1, "page__header"], [1, "back-btn", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round"], ["d", "M19 12H5m0 0l7 7m-7-7l7-7"], [1, "page__title"], [1, "connect-card"], [1, "connect-card__logo"], [1, "connect-card__info"], [1, "connect-card__title"], [1, "connect-card__sub"], ["size", "sm", 3, "clicked", "variant"], [1, "prefs"], [1, "prefs__label"], [1, "pref-list"], [1, "pref-row"], [1, "pref-row__title"], [1, "pref-row__sub"], [3, "toggled", "checked"]], template: function GoogleIntegrationsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(16);
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(17, GoogleIntegrationsComponent_Conditional_17_Template, 25, 3, "div", 12);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(14);
...
</div>`, styles: ["/* apps/morador/src/app/features/profile/google-integrations.component.css */\n.page {\n  min-height: 100%;\n  padding-bottom: 80px;\n}\n.page__header {\n  display: flex;\n  align-items: center;\n  gap: var(--s-4);\n  padding: var(--s-5);\n  background: var(--c-bg-raised);\n  border-bottom: 1px solid var(--c-border);\n}\n.page__title {\n  font-family: var(--font-serif);\n  font-size: 22px;\n  font-weight: 400;\n  margin: 0;\n}\n.back-btn {\n  width: 36px;\n  height: 36px;\n  border-radius: var(--r-sm);\n  border: 1px solid var(--c-border);\n  background: transparent;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n  color: var(--c-text);\n}\n.connect-card {\n  display: flex;\n  align-items: center;\n  gap: var(--s-4);\n  padding: var(--s-5);\n  margin: var(--s-5);\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  border: 1px solid var(--c-border);\n}\n.connect-card__logo {\n  width: 44px;\n  height: 44px;\n  border-radius: 50%;\n  background: #4285F4;\n  color: #fff;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: var(--font-serif);\n  font-size: 20px;\n  flex-shrink: 0;\n}\n.connect-card__info {\n  flex: 1;\n}\n.connect-card__title {\n  font-size: 15px;\n  font-weight: 600;\n  margin: 0 0 2px;\n}\n.connect-card__sub {\n  font-size: 12px;\n  color: var(--c-text-muted);\n  margin: 0;\n}\n.prefs {\n  padding: 0 var(--s-5);\n}\n.prefs__label {\n  font-size: 11px;\n  font-weight: 600;\n  text-transform: uppercase;\n  letter-spacing: 0.8px;\n  color: var(--c-text-muted);\n  margin: 0 0 var(--s-3);\n}\n.pref-list {\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  overflow: hidden;\n  border: 1px solid var(--c-border);\n}\n.pref-row {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: var(--s-4);\n  border-bottom: 1px solid var(--c-border);\n}\n.pref-row:last-child {\n  border-bottom: none;\n}\n.pref-row__title {\n  font-size: 14px;\n  font-weight: 600;\n  margin: 0 0 2px;\n}\n.pref-row__sub {\n  font-size: 12px;\n  color: var(--c-text-muted);\n  margin: 0;\n}\n/*# sourceMappingURL=google-integrations.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-XWAQBZUS.js.map
