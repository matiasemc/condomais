...
// apps/morador/src/app/features/unauthorized/unauthorized.component.ts
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UnauthorizedComponent, [{
    ...
    args: [{
      ...
      standalone: true,
      imports: [RouterLink],
      template: `<div style="text-align:center;padding:60px"><h2>Acesso n\xE3o autorizado</h2><a routerLink="/login">Voltar ao login</a></div>`
    }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(UnauthorizedComponent, { className: "UnauthorizedComponent", filePath: "apps/morador/src/app/features/unauthorized/unauthorized.component.ts", lineNumber: 7 });
})();
export {
  UnauthorizedComponent
};
//# sourceMappingURL=chunk-7UQ3GYDW.js.map
