...
function AnnouncementsComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "div");
    \u0275\u0275elementStart(2, "div", 5)(3, "div", 6)(4, "span", 7);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, AnnouncementsComponent_For_6_Conditional_6_Template, 2, 0, "cm-badge", 8);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275classMap("announce-row__bar announce-row__bar--" + a_r1.prioridade);
    \u0275\u0275advance(4);
...
var AnnouncementsComponent = class _AnnouncementsComponent {
  constructor() {
    ...
    this.avisos = this.announcementService.announcements;
    effect(() => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AnnouncementsComponent, selectors: [["cm-announcements"]], decls: 7, vars: 0, consts: [[1, "page"], [1, "page__header"], [1, "page__title"], [1, "list"], [1, "announce-row", 3, "routerLink"], [1, "announce-row__body"], [1, "announce-row__top"], [1, "announce-row__title"], ["variant", "accent"], [1, "announce-row__msg"], [1, "announce-row__date"]], template: function AnnouncementsComponent_Template(rf, ctx) {
      if (rf & 1) {
...
//# sourceMappingURL=chunk-PPN3SGVF.js.map
