...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-SWI64NIH.js").then((m4) => m4);
...
var environment = {
  production: false,
  supabase: {
    url: "https://qhujhbrzvufoxlhtbqbt.supabase.co",
    anonKey: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFodWpoYnJ6dnVmb3hsaHRicWJ0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY2MzQwMDMsImV4cCI6MjA5MjIxMDAwM30.aWEi_SIFaCF4JZaWBHziWor5vQEyUoVaujicDo4dXVA"
  }
};

// apps/morador/src/app/app.routes.ts
var routes = [
  { path: "login", loadComponent: () => import("./chunk-7ZZ4Q636.js").then((m4) => m4.LoginComponent) },
  ...
  { path: "unauthorized", loadComponent: () => import("./chunk-ABRXURCD.js").then((m4) => m4.UnauthorizedComponent) },
  {
    path: "",
    canActivate: [authGuard, contextGuard("morador"), roleGuard(["MORADOR", "SINDICO", "CONSELHO", "ADMIN"])],
    loadComponent: () => import("./chunk-5UUL5K7I.js").then((m4) => m4.AppShellComponent),
    children: [
      { path: "", redirectTo: "home", pathMatch: "full" },
      { path: "home", loadComponent: () => import("./chunk-OIXRTO47.js").then((m4) => m4.HomeComponent) },
      { path: "entregas", loadComponent: () => import("./chunk-6Q63GA2B.js").then((m4) => m4.DeliveriesComponent) },
      { path: "entregas/:id", loadComponent: () => import("./chunk-SPA44HB6.js").then((m4) => m4.DeliveryDetailComponent) },
      { path: "ocorrencias", loadComponent: () => import("./chunk-EVPKKGDR.js").then((m4) => m4.OccurrencesComponent) },
      { path: "ocorrencias/nova", loadComponent: () => import("./chunk-WCXJ4LIR.js").then((m4) => m4.NewOccurrenceComponent) },
      { path: "ocorrencias/:id", loadComponent: () => import("./chunk-XSSFYRRZ.js").then((m4) => m4.OccurrenceDetailComponent) },
      { path: "reservas", loadComponent: () => import("./chunk-C27AKBQO.js").then((m4) => m4.ReservationsComponent) },
      { path: "reservas/nova", loadComponent: () => import("./chunk-LDKJ6ZQG.js").then((m4) => m4.NewReservationComponent) },
      { path: "reservas/admin", canActivate: [roleGuard(["SINDICO", "CONSELHO"])], loadComponent: () => import("./chunk-T2OQY4QA.js").then((m4) => m4.AdminReservasComponent) },
      { path: "marketplace", loadComponent: () => import("./chunk-MPUSW5JN.js").then((m4) => m4.MarketplaceComponent) },
      { path: "marketplace/:id", loadComponent: () => import("./chunk-6KQOQBCO.js").then((m4) => m4.MarketplaceDetailComponent) },
      { path: "avisos", loadComponent: () => import("./chunk-PPN3SGVF.js").then((m4) => m4.AnnouncementsComponent) },
      { path: "avisos/:id", loadComponent: () => import("./chunk-OEB3UZUO.js").then((m4) => m4.AnnouncementDetailComponent) },
      { path: "notificacoes", loadComponent: () => import("./chunk-25ORSGII.js").then((m4) => m4.NotificationsComponent) },
      { path: "perfil", loadComponent: () => import("./chunk-IB3P3W5Y.js").then((m4) => m4.ProfileComponent) },
      { path: "integracoes", loadComponent: () => import("./chunk-XWAQBZUS.js").then((m4) => m4.GoogleIntegrationsComponent) },
      { path: "billing", loadComponent: () => import("./chunk-4JSNZLLS.js").then((m4) => m4.BillingComponent) }
    ]
  },
...
var appConfig = {
  providers: [
    ...
    providePrimeNG({ theme: { preset: km } }),
    MessageService,
