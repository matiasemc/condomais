...
function ResidentsComponent_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(8, ResidentsComponent_Conditional_8_For_2_Conditional_8_Template, 2, 2, "cm-badge", 15)(9, ResidentsComponent_Conditional_8_For_2_Conditional_9_Template, 2, 0, "cm-badge", 16);
    \u0275\u0275namespaceSVG();
...
var ResidentsComponent = class _ResidentsComponent {
  constructor() {
    this.search = signal("");
    this.activeFilter = signal("todos");
    this.filters = [
      { id: "todos", label: "Todos" },
      { id: "com_entrega", label: "Com entrega" },
      { id: "inativos", label: "Inativos" }
    ];
    this.allResidents = signal([
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResidentsComponent, selectors: [["cm-residents"]], decls: 9, vars: 2, consts: [[1, "residents-page"], ["title", "Moradores", "eyebrow", "GEST\xC3O"], [1, "search-bar"], ["placeholder", "Buscar por nome ou apto\u2026", 3, "valueChange", "value"], [1, "filter-chips"], [1, "chip", 3, "chip--active"], ["icon", "\u{1F464}", "title", "Nenhum morador", "subtitle", "Tente outro filtro ou busca"], [1, "resident-list"], [1, "chip", 3, "click"], [1, "resident-card", 3, "routerLink"], [3, "name", "color"], [1, "resident-info"], [1, "resident-name"], [1, "resident-unit"], [1, "resident-end"], ["variant", "warn"], ["variant", "neutral"], ["width", "16", "height", "16", "viewBox", "0 0 16 16", "fill", "none"], ["d", "M6 4l4 4-4 4", "stroke", "currentColor", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"]], template: function ResidentsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd();
        \u0275\u0275template(7, ResidentsComponent_Conditional_7_Template, 1, 0, "cm-empty-state", 6)(8, ResidentsComponent_Conditional_8_Template, 3, 0, "div", 7);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
...
`, styles: ["/* apps/porteiro/src/app/features/residents/residents.component.scss */\n.residents-page {\n  padding: var(--s-4);\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-4);\n}\n.search-bar {\n  width: 100%;\n}\n.filter-chips {\n  display: flex;\n  gap: var(--s-2);\n  flex-wrap: wrap;\n}\n.chip {\n  padding: var(--s-1) var(--s-3);\n  border-radius: var(--r-pill);\n  border: 1.5px solid var(--c-card-muted);\n  background: var(--c-card);\n  color: var(--c-text-muted);\n  font-size: 13px;\n  font-weight: 500;\n  cursor: pointer;\n  transition: all 0.15s;\n}\n.chip--active {\n  background: var(--c-accent);\n  border-color: var(--c-accent);\n  color: #fff;\n}\n.resident-list {\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-2);\n}\n.resident-card {\n  display: flex;\n  align-items: center;\n  gap: var(--s-3);\n  padding: var(--s-3) var(--s-4);\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  text-decoration: none;\n  color: inherit;\n  transition: opacity 0.15s;\n}\n.resident-card:active {\n  opacity: 0.7;\n}\n.resident-info {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.resident-name {\n  font-size: 15px;\n  font-weight: 600;\n  color: var(--c-text);\n}\n.resident-unit {\n  font-size: 13px;\n  color: var(--c-text-muted);\n}\n.resident-end {\n  display: flex;\n  align-items: center;\n  gap: var(--s-2);\n  color: var(--c-text-muted);\n}\n/*# sourceMappingURL=residents.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResidentsComponent, { className: "ResidentsComponent", filePath: "apps/porteiro/src/app/features/residents/residents.component.ts", lineNumber: 22 });
})();
export {
  ResidentsComponent
};
//# sourceMappingURL=chunk-Y5OF45H5.js.map
