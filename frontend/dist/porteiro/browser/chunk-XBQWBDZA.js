...
function OccurrencesComponent_Conditional_5_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(o_r1.type);
    \u0275\u0275advance();
    \u0275\u0275property("variant", o_r1.status === "aberta" ? "warn" : "success");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(o_r1.status);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(o_r1.description);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("Apto ", o_r1.unit, " \xB7 ", \u0275\u0275pipeBind2(10, 6, o_r1.reportedAt, "dd/MM HH:mm"), "");
  }
}
...
var OccurrencesComponent = class _OccurrencesComponent {
  constructor() {
    this.occurrences = signal([
      { id: "1", type: "Barulho", description: "M\xFAsica alta ap\xF3s as 22h no apto 205.", unit: "101", reportedAt: "2026-04-19T22:30:00", status: "aberta" },
      { id: "2", type: "Danos", description: "Vidro quebrado no corredor do 3\xBA andar.", unit: "301", reportedAt: "2026-04-18T14:00:00", status: "aberta" },
      { id: "3", type: "Seguran\xE7a", description: "Porta de servi\xE7o encontrada aberta.", unit: "102", reportedAt: "2026-04-17T08:00:00", status: "resolvida" }
    ]);
  }
  static {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OccurrencesComponent, selectors: [["cm-occurrences"]], decls: 6, vars: 1, consts: [[1, "occurrences-page"], ["title", "Ocorr\xEAncias", "eyebrow", "REGISTRO"], ["routerLink", "/ocorrencias/nova", 1, "new-btn"], ["icon", "\u{1F4CB}", "title", "Sem ocorr\xEAncias", "subtitle", "Nenhuma ocorr\xEAncia registrada"], [1, "occurrence-list"], [1, "occurrence-card"], [1, "occurrence-header"], [1, "occurrence-type"], [3, "variant"], [1, "occurrence-desc"], [1, "occurrence-meta"]], template: function OccurrencesComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "cm-section-header", 1)(2, "a", 2);
        \u0275\u0275text(3, "+ Nova");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(4, OccurrencesComponent_Conditional_4_Template, 1, 0, "cm-empty-state", 3)(5, OccurrencesComponent_Conditional_5_Template, 3, 0, "div", 4);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
...
(() => {
  ...
  <cm-section-header title="Ocorr\xEAncias" eyebrow="REGISTRO">
    <a routerLink="/ocorrencias/nova" class="new-btn">+ Nova</a>
  </cm-section-header>

  @if (occurrences().length === 0) {
    <cm-empty-state icon="\u{1F4CB}" title="Sem ocorr\xEAncias" subtitle="Nenhuma ocorr\xEAncia registrada"></cm-empty-state>
  } @else {
    <div class="occurrence-list">
      @for (o of occurrences(); track o.id) {
        <div class="occurrence-card">
          <div class="occurrence-header">
            <span class="occurrence-type">{{ o.type }}</span>
            <cm-badge [variant]="o.status === 'aberta' ? 'warn' : 'success'">{{ o.status }}</cm-badge>
          </div>
          <p class="occurrence-desc">{{ o.description }}</p>
          <span class="occurrence-meta">Apto {{ o.unit }} \xB7 {{ o.reportedAt | date:"dd/MM HH:mm" }}</span>
        </div>
      }
    </div>
  }
</div>`, styles: ["/* apps/porteiro/src/app/features/occurrences/occurrences.component.scss */\n.occurrences-page {\n  padding: var(--s-4);\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-4);\n}\n.new-btn {\n  font-size: 13px;\n  font-weight: 600;\n  color: var(--c-accent);\n  text-decoration: none;\n  padding: var(--s-1) var(--s-3);\n  border: 1.5px solid var(--c-accent);\n  border-radius: var(--r-pill);\n}\n.occurrence-list {\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-3);\n}\n.occurrence-card {\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  padding: var(--s-4);\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-2);\n}\n.occurrence-header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.occurrence-type {\n  font-size: 15px;\n  font-weight: 700;\n  color: var(--c-text);\n}\n.occurrence-desc {\n  font-size: 14px;\n  color: var(--c-text-muted);\n  margin: 0;\n  line-height: 1.5;\n}\n.occurrence-meta {\n  font-size: 12px;\n  color: var(--c-text-muted);\n}\n/*# sourceMappingURL=occurrences.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OccurrencesComponent, { className: "OccurrencesComponent", filePath: "apps/porteiro/src/app/features/occurrences/occurrences.component.ts", lineNumber: 24 });
})();
export {
  OccurrencesComponent
};
//# sourceMappingURL=chunk-XBQWBDZA.js.map
