...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-GB3DVIDC.js").then((m4) => m4);
...
var routes = [
  { path: "login", loadComponent: () => import("./chunk-YEUKLCQY.js").then((m4) => m4.LoginComponent) },
  ...
  { path: "unauthorized", loadComponent: () => import("./chunk-DATB6AOO.js").then((m4) => m4.UnauthorizedComponent) },
  {
    path: "",
    canActivate: [authGuard, contextGuard("porteiro"), roleGuard(["PORTEIRO", "SINDICO"])],
    loadComponent: () => import("./chunk-SZHV7YMD.js").then((m4) => m4.AppShellComponent),
    children: [
      { path: "", redirectTo: "home", pathMatch: "full" },
      { path: "home", loadComponent: () => import("./chunk-BHPVYGX6.js").then((m4) => m4.HomeComponent) },
      { path: "moradores", loadComponent: () => import("./chunk-3LMKS7FP.js").then((m4) => m4.ResidentsComponent) },
      { path: "moradores/:id", loadComponent: () => import("./chunk-ZNZR56JI.js").then((m4) => m4.ResidentDetailComponent) },
      { path: "entregas", loadComponent: () => import("./chunk-M7PYFMLL.js").then((m4) => m4.DeliveriesComponent) },
      { path: "entregas/nova", loadComponent: () => import("./chunk-MBLHEKTY.js").then((m4) => m4.NewDeliveryComponent) },
      { path: "avisos", loadComponent: () => import("./chunk-LHALU4SZ.js").then((m4) => m4.AnnouncementsComponent) },
      { path: "ocorrencias", loadComponent: () => import("./chunk-EFLQLF2L.js").then((m4) => m4.OccurrencesComponent) },
      { path: "ocorrencias/nova", loadComponent: () => import("./chunk-VZU6RYZI.js").then((m4) => m4.NewOccurrenceComponent) }
    ]
  },
