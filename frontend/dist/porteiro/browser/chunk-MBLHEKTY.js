...
var DomHandler = class _DomHandler {
  ...
  static matches(element, selector) {
    ...
    var f = p2["matches"] || p2.webkitMatchesSelector || p2["mozMatchesSelector"] || p2["msMatchesSelector"] || function(s3) {
  ...
  static getOuterWidth(el, margin) {
    ...
    if (margin) {
      let style10 = getComputedStyle(el);
      width += parseFloat(style10.marginLeft) + parseFloat(style10.marginRight);
    }
    return width;
  }
  static getHorizontalPadding(el) {
    let style10 = getComputedStyle(el);
    return parseFloat(style10.paddingLeft) + parseFloat(style10.paddingRight);
  }
  static getHorizontalMargin(el) {
    let style10 = getComputedStyle(el);
    return parseFloat(style10.marginLeft) + parseFloat(style10.marginRight);
  }
  static innerWidth(el) {
    let width = el.offsetWidth;
    let style10 = getComputedStyle(el);
    width += parseFloat(style10.paddingLeft) + parseFloat(style10.paddingRight);
    return width;
  }
  static width(el) {
    let width = el.offsetWidth;
  ...
  static getInnerHeight(el) {
    ...
    let style10 = getComputedStyle(el);
    height += parseFloat(style10.paddingTop) + parseFloat(style10.paddingBottom);
    return height;
  }
  static getOuterHeight(el, margin) {
    ...
    if (margin) {
      let style10 = getComputedStyle(el);
      height += parseFloat(style10.marginTop) + parseFloat(style10.marginBottom);
    }
    return height;
  }
  static getHeight(el) {
    let height = el.offsetHeight;
    let style10 = getComputedStyle(el);
    height -= parseFloat(style10.paddingTop) + parseFloat(style10.paddingBottom) + parseFloat(style10.borderTopWidth) + parseFloat(style10.borderBottomWidth);
    return height;
  }
  static getWidth(el) {
    let width = el.offsetWidth;
    let style10 = getComputedStyle(el);
    width -= parseFloat(style10.paddingLeft) + parseFloat(style10.paddingRight) + parseFloat(style10.borderLeftWidth) + parseFloat(style10.borderRightWidth);
    return width;
  }
  static getViewport() {
  ...
  static calculateScrollbarWidth(el) {
    if (el) {
      let style10 = getComputedStyle(el);
      return el.offsetWidth - el.clientWidth - parseFloat(style10.borderLeftWidth) - parseFloat(style10.borderRightWidth);
    } else {
...
var Scroller = class _Scroller extends BaseComponent {
  ...
  getContentPosition() {
    if (this.contentEl) {
      const style10 = getComputedStyle(this.contentEl);
      const left = parseFloat(style10.paddingLeft) + Math.max(parseFloat(style10.left) || 0, 0);
      const right = parseFloat(style10.paddingRight) + Math.max(parseFloat(style10.right) || 0, 0);
      const top = parseFloat(style10.paddingTop) + Math.max(parseFloat(style10.top) || 0, 0);
      const bottom = parseFloat(style10.paddingBottom) + Math.max(parseFloat(style10.bottom) || 0, 0);
      return {
        left,
        right,
        top,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        \u0275\u0275contentQuery(dirIndex, _c09, 4)(dirIndex, _c12, 4)(dirIndex, _c22, 4)(dirIndex, _c32, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
        \u0275\u0275queryRefresh(_t = \u0275\u0275loadQuery()) && (ctx.contentTemplate = _t.first);
...
function Select_ng_template_9_p_scroller_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(9, _c010, ctx_r2.scrollHeight));
...
function Select_ng_template_9_ng_template_8_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(8, _c010, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("optionGroup"));
...
function Select_ng_template_9_ng_template_8_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(5, _c010, scrollerOptions_r19.itemSize + "px"))("pBind", ctx_r2.ptm("emptyMessage"));
    \u0275\u0275advance();
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    template: function SelectItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275property("id", ctx.id)("pBind", ctx.getPTOptions())("ngStyle", \u0275\u0275pureFunction1(17, _c010, (ctx.scrollerOptions == null ? null : ctx.scrollerOptions.itemSize) + "px"));
...
function NewDeliveryComponent_Conditional_4_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", r_r6.name, " - Apto ", r_r6.unit);
  }
}
function NewDeliveryComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, NewDeliveryComponent_Conditional_4_Conditional_1_Template, 4, 3, "div", 13);
    \u0275\u0275elementStart(2, "div", 14)(3, "label", 15);
    \u0275\u0275text(4, "Tipo de entrega");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "p-select", 16);
    \u0275\u0275listener("ngModelChange", function NewDeliveryComponent_Conditional_4_Template_p_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.deliveryType.set($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 14)(7, "label", 15);
    \u0275\u0275text(8, "Observacoes (opcional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "textarea", 17);
    \u0275\u0275listener("input", function NewDeliveryComponent_Conditional_4_Template_textarea_input_9_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.notes.set($event.target.value));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 18)(11, "cm-button", 19);
    \u0275\u0275listener("click", function NewDeliveryComponent_Conditional_4_Template_cm_button_click_11_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(12, "Voltar");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "cm-button", 20);
    \u0275\u0275listener("click", function NewDeliveryComponent_Conditional_4_Template_cm_button_click_13_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("options", ctx_r1.deliveryTypeOptions)("ngModel", ctx_r1.deliveryType());
    \u0275\u0275advance(4);
...
function NewDeliveryComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4)(1, "div", 21);
    \u0275\u0275text(2, "OK");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(6, "O morador sera notificado.");
    \u0275\u0275elementEnd()();
  }
}
var NewDeliveryComponent = class _NewDeliveryComponent {
  constructor() {
    ...
    this.steps = ["Morador", "Detalhes", "Conclu\xC3\xADdo"];
    ...
    this.activeStep = signal(0, ...ngDevMode ? [{ debugName: "activeStep" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.deliveryType = signal("", ...ngDevMode ? [{ debugName: "deliveryType" }] : (
      /* istanbul ignore next */
      []
    ));
    this.notes = signal("", ...ngDevMode ? [{ debugName: "notes" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    this.isLoadingRes = signal(false, ...ngDevMode ? [{ debugName: "isLoadingRes" }] : (
      /* istanbul ignore next */
      []
    ));
    this.filteredResidents = computed(() => {
      const q = this.search().toLowerCase();
      return this.residents().filter((r) => r.name.toLowerCase().includes(q) || r.unit.includes(q));
    }, ...ngDevMode ? [{ debugName: "filteredResidents" }] : (
      /* istanbul ignore next */
      []
    ));
    effect(() => {
  ...
  confirmar() {
    return __async(this, null, function* () {
      ...
      const tipo = this.deliveryType();
      if (!tenant || !resident || !tipo)
        return;
      const delivery = yield this.deliveryService.create({
        condominioId: tenant.id,
        unidade: resident.unit,
        moradorId: resident.id,
        tipo,
        descricao: this.notes() || void 0
      });
      if (delivery) {
  ...
  voltar() {
    if (this.activeStep() > 0)
      this.activeStep.update((s3) => s3 - 1);
    else
      this.router.navigate(["/entregas"]);
  }
  static {
    this.\u0275fac = function NewDeliveryComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NewDeliveryComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NewDeliveryComponent, selectors: [["cm-new-delivery"]], decls: 6, vars: 5, consts: [[1, "new-delivery-page"], ["title", "Nova Entrega", "eyebrow", "PORTARIA"], [3, "steps", "activeStep"], [1, "step"], [1, "step", "step--success"], ["placeholder", "Buscar morador...", 3, "valueChange", "value"], [1, "resident-options"], [1, "resident-opt"], [1, "resident-opt", 3, "click"], [3, "name"], [1, "opt-info"], [1, "opt-name"], [1, "opt-unit"], [1, "selected-resident"], [1, "field"], [1, "field-label"], ["styleClass", "field-select", "optionLabel", "label", "optionValue", "value", "placeholder", "Selecione...", "appendTo", "body", 3, "ngModelChange", "options", "ngModel"], ["placeholder", "Ex: fragil, requer assinatura...", 1, "field-textarea", 3, "input", "value"], [1, "step-actions"], ["variant", "ghost", 3, "click"], ["variant", "accent", 3, "click", "disabled"], [1, "success-icon"], [1, "success-title"], [1, "success-sub"]], template: function NewDeliveryComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275element(1, "cm-section-header", 1)(2, "cm-stepper", 2);
        \u0275\u0275conditionalCreate(3, NewDeliveryComponent_Conditional_3_Template, 5, 1, "div", 3);
        \u0275\u0275conditionalCreate(4, NewDeliveryComponent_Conditional_4_Template, 15, 5, "div", 3);
        \u0275\u0275conditionalCreate(5, NewDeliveryComponent_Conditional_5_Template, 7, 0, "div", 4);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
