...
function ResidentDetailComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(16, "+ Entrega");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(17, ResidentDetailComponent_Conditional_1_Conditional_17_Template, 5, 0, "section", 13);
    \u0275\u0275conditionalCreate(18, ResidentDetailComponent_Conditional_1_Conditional_18_Template, 5, 0, "section", 13);
    \u0275\u0275conditionalCreate(19, ResidentDetailComponent_Conditional_1_Conditional_19_Template, 5, 0, "div", 14);
  }
  if (rf & 2) {
    const r_r5 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
...
var ResidentDetailComponent = class _ResidentDetailComponent {
  constructor(route) {
    ...
    this.resident = signal(null, ...ngDevMode ? [{ debugName: "resident" }] : (
      /* istanbul ignore next */
      []
    ));
    this.pendingDeliveries = computed(() => this.resident()?.deliveries.filter((d) => d.status === "pendente") ?? [], ...ngDevMode ? [{ debugName: "pendingDeliveries" }] : (
      /* istanbul ignore next */
      []
    ));
    this.pastDeliveries = computed(() => this.resident()?.deliveries.filter((d) => d.status === "retirada") ?? [], ...ngDevMode ? [{ debugName: "pastDeliveries" }] : (
      /* istanbul ignore next */
      []
    ));
    ...
    if (id && tenant)
      void this.loadResident(tenant.id, id);
  }
  notificar() {
    this.toast.show({ message: "Notificacao enviada via WhatsApp", type: "success" });
  }
  loadResident(condominioId, userId) {
    return __async(this, null, function* () {
      this.resident.set(yield this.residentService.loadProfile(condominioId, userId));
    });
  }
  static {
    this.\u0275fac = function ResidentDetailComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ResidentDetailComponent)(\u0275\u0275directiveInject(ActivatedRoute));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ResidentDetailComponent, selectors: [["cm-resident-detail"]], decls: 2, vars: 1, consts: [[1, "detail-page"], [1, "detail-header"], ["routerLink", "/moradores", 1, "back-btn"], ["width", "20", "height", "20", "viewBox", "0 0 20 20", "fill", "none"], ["d", "M12 5l-5 5 5 5", "stroke", "currentColor", "stroke-width", "1.5", "stroke-linecap", "round", "stroke-linejoin", "round"], [3, "name", "size"], [1, "detail-identity"], [1, "detail-name"], [1, "detail-unit"], [3, "variant"], [1, "action-row"], ["variant", "accent", 3, "click"], ["variant", "primary", "routerLink", "/entregas/nova"], [1, "detail-section"], [1, "empty-deliveries"], [1, "section-title"], ["icon", "\u{1F4E6}", 3, "title", "subtitle"], ["slot", "end", "variant", "warn"], ["icon", "\u2705", 3, "title", "subtitle"], [1, "empty-icon"]], template: function ResidentDetailComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275conditionalCreate(1, ResidentDetailComponent_Conditional_1_Template, 20, 9);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        let tmp_0_0;
...
</div>`, styles: ["/* apps/porteiro/src/app/features/residents/resident-detail.component.css */\n.detail-page {\n  padding: var(--s-4);\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-4);\n}\n.detail-header {\n  display: flex;\n  align-items: center;\n  gap: var(--s-3);\n  padding-bottom: var(--s-3);\n  border-bottom: 1px solid var(--c-card-muted);\n}\n.back-btn {\n  display: flex;\n  align-items: center;\n  color: var(--c-text-muted);\n  text-decoration: none;\n}\n.detail-identity {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.detail-name {\n  font-size: 17px;\n  font-weight: 700;\n  color: var(--c-text);\n  margin: 0;\n}\n.detail-unit {\n  font-size: 13px;\n  color: var(--c-text-muted);\n}\n.action-row {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: var(--s-3);\n}\n.detail-section {\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-2);\n}\n.section-title {\n  font-size: 13px;\n  font-weight: 600;\n  color: var(--c-text-muted);\n  text-transform: uppercase;\n  letter-spacing: 0.06em;\n  margin: 0;\n}\n.empty-deliveries {\n  text-align: center;\n  padding: var(--s-7) 0;\n  color: var(--c-text-muted);\n}\n.empty-icon {\n  font-size: 40px;\n  display: block;\n  margin-bottom: var(--s-3);\n}\n/*# sourceMappingURL=resident-detail.component.css.map */\n"] }]
  }], () => [{ type: ActivatedRoute }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ResidentDetailComponent, { className: "ResidentDetailComponent", filePath: "apps/porteiro/src/app/features/residents/resident-detail.component.ts", lineNumber: 17 });
})();
export {
  ResidentDetailComponent
};
//# sourceMappingURL=chunk-ZNZR56JI.js.map
