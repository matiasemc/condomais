...
function HomeComponent_For_40_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(6, _c0))("queryParams", \u0275\u0275pureFunction1(7, _c1, d_r2.id));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("Apto ", d_r2.unidade);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(d_r2.transportadora || d_r2.descricao || d_r2.tipo);
    \u0275\u0275advance();
...
var HomeComponent = class _HomeComponent {
  constructor() {
    ...
    this.recentDeliveries = computed(() => this.deliveries().slice(0, 3), ...ngDevMode ? [{ debugName: "recentDeliveries" }] : (
      /* istanbul ignore next */
      []
    ));
    effect(() => {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["cm-porteiro-home"]], decls: 41, vars: 0, consts: [[1, "home"], [1, "home__header"], [1, "home__eyebrow"], [1, "home__title"], [1, "home__sync"], [1, "sync-dot"], [1, "kpi-grid"], [3, "label", "value", "inverted"], [1, "actions"], ["routerLink", "/entregas/nova", 1, "action-btn"], [1, "action-btn__icon"], ["routerLink", "/moradores", 1, "action-btn"], ["routerLink", "/ocorrencias/nova", 1, "action-btn"], ["routerLink", "/avisos", 1, "action-btn"], [1, "section"], [1, "section__label"], [1, "delivery-list"], [1, "delivery-row", 3, "routerLink", "queryParams"], [1, "delivery-row__icon"], [1, "delivery-row__body"], [1, "delivery-row__title"], [1, "delivery-row__sub"], [3, "variant"]], template: function HomeComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275repeaterCreate(39, HomeComponent_For_40_Template, 10, 9, "a", 17, _forTrack1);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(12);
...
(() => {
  ...
  <div class="actions">
    ...
    <a class="action-btn" routerLink="/avisos">
      <span class="action-btn__icon">i</span>
      <span>Avisos</span>
    </a>
  </div>
      ...
      @for (d of recentDeliveries(); track d.id) {
        <a class="delivery-row" [routerLink]="['/entregas']" [queryParams]="{id: d.id}">
          ...
          <div class="delivery-row__body">
            <p class="delivery-row__title">Apto {{ d.unidade }}</p>
            <p class="delivery-row__sub">{{ d.transportadora || d.descricao || d.tipo }}</p>
          </div>
          <cm-badge [variant]="d.status === 'pendente' || d.status === 'notificada' ? 'accent' : 'success'">{{ d.status }}</cm-badge>
        </a>
      }
    </div>
  </div>
</div>
`, styles: ["/* apps/porteiro/src/app/features/home/home.component.css */\n.home {\n  padding: var(--s-5);\n  display: flex;\n  flex-direction: column;\n  gap: var(--s-6);\n}\n.home__header {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  padding-top: var(--s-3);\n}\n.home__eyebrow {\n  font-size: 11px;\n  font-weight: 600;\n  text-transform: uppercase;\n  letter-spacing: 0.8px;\n  color: var(--c-text-muted);\n  margin: 0 0 var(--s-1);\n}\n.home__title {\n  font-family: var(--font-serif);\n  font-size: 26px;\n  font-weight: 400;\n  letter-spacing: -0.4px;\n  margin: 0;\n}\n.home__sync {\n  display: flex;\n  align-items: center;\n  gap: var(--s-2);\n  font-size: 12px;\n  color: var(--c-success);\n  font-weight: 600;\n}\n.sync-dot {\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background: var(--c-success);\n  animation: pulse 2s ease-in-out infinite;\n}\n.kpi-grid {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: var(--s-3);\n}\n@media (min-width: 900px) {\n  .kpi-grid {\n    grid-template-columns: repeat(4, 1fr);\n  }\n}\n.actions {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: var(--s-3);\n}\n@media (min-width: 900px) {\n  .actions {\n    grid-template-columns: repeat(4, 1fr);\n  }\n}\n.action-btn {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: var(--s-3);\n  padding: var(--s-5) var(--s-2);\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  box-shadow: var(--sh-sm);\n  text-decoration: none;\n  color: var(--c-text);\n  transition: transform var(--t-fast);\n}\n.action-btn:active {\n  transform: scale(0.97);\n}\n.action-btn__icon {\n  font-size: 28px;\n}\n.action-btn span:last-child {\n  font-size: 13px;\n  font-weight: 500;\n  text-align: center;\n}\n.section__label {\n  font-size: 11px;\n  font-weight: 600;\n  text-transform: uppercase;\n  letter-spacing: 0.8px;\n  color: var(--c-text-muted);\n  margin: 0 0 var(--s-3);\n}\n.delivery-list {\n  display: flex;\n  flex-direction: column;\n  background: var(--c-card);\n  border-radius: var(--r-md);\n  overflow: hidden;\n  border: 1px solid var(--c-border);\n}\n.delivery-row {\n  display: flex;\n  align-items: center;\n  gap: var(--s-3);\n  padding: var(--s-4);\n  border-bottom: 1px solid var(--c-border);\n  text-decoration: none;\n  color: var(--c-text);\n  transition: background var(--t-fast);\n}\n.delivery-row:last-child {\n  border-bottom: none;\n}\n.delivery-row:hover {\n  background: var(--c-bg);\n}\n.delivery-row__icon {\n  font-size: 20px;\n}\n.delivery-row__body {\n  flex: 1;\n}\n.delivery-row__title {\n  font-size: 13px;\n  font-weight: 600;\n  margin: 0 0 2px;\n}\n.delivery-row__sub {\n  font-size: 12px;\n  color: var(--c-text-muted);\n  margin: 0;\n}\n/*# sourceMappingURL=home.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
...
//# sourceMappingURL=chunk-BHPVYGX6.js.map
