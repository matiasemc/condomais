    ...
    <aside class="sidebar">
      ...
      <div class="sidebar__footer">
        <a class="sidebar__item sidebar__item--muted" href="http://localhost:4200" target="_blank">
          <span>\xF0\u0178\x8F\xA0</span>
          <span>App morador</span>
        </a>
      </div>
    </aside>
  `, styles: ["/* apps/porteiro/src/app/layout/sidebar/sidebar.component.css */\n.sidebar {\n  width: 240px;\n  height: 100dvh;\n  background: var(--c-bg-raised);\n  border-right: 1px solid var(--c-border);\n  display: flex;\n  flex-direction: column;\n  flex-shrink: 0;\n}\n.sidebar__brand {\n  display: flex;\n  align-items: center;\n  gap: var(--s-3);\n  padding: var(--s-5) var(--s-5) var(--s-4);\n  border-bottom: 1px solid var(--c-border);\n}\n.sidebar__logo {\n  width: 36px;\n  height: 36px;\n  border-radius: var(--r-sm);\n  background: var(--c-accent);\n  color: #fff;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: var(--font-serif);\n  font-size: 14px;\n}\n.sidebar__name {\n  font-weight: 700;\n  font-size: 14px;\n  margin: 0;\n}\n.sidebar__role {\n  font-size: 11px;\n  color: var(--c-text-muted);\n  margin: 0;\n}\n.sidebar__nav {\n  flex: 1;\n  padding: var(--s-4) var(--s-3);\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.sidebar__item {\n  display: flex;\n  align-items: center;\n  gap: var(--s-3);\n  padding: var(--s-3) var(--s-3);\n  border-radius: var(--r-sm);\n  text-decoration: none;\n  color: var(--c-text-muted);\n  font-size: 14px;\n  font-weight: 500;\n  transition: all var(--t-fast);\n}\n.sidebar__item:hover {\n  background: var(--c-card-muted);\n  color: var(--c-text);\n}\n.sidebar__item--active {\n  background: var(--c-accent-soft);\n  color: var(--c-accent-dark);\n  font-weight: 600;\n}\n.sidebar__item--muted {\n  color: var(--c-text-faint);\n  font-size: 13px;\n}\n.sidebar__icon {\n  display: flex;\n  flex-shrink: 0;\n}\n.sidebar__footer {\n  padding: var(--s-4) var(--s-3);\n  border-top: 1px solid var(--c-border);\n}\n/*# sourceMappingURL=sidebar.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
(() => {
  ...
  `, styles: ["/* apps/porteiro/src/app/layout/bottom-nav/bottom-nav.component.css */\n.bottom-nav {\n  display: flex;\n  background: var(--c-bg-raised);\n  border-top: 1px solid var(--c-border);\n  padding: var(--s-2) 0;\n  padding-bottom: calc(var(--s-2) + env(safe-area-inset-bottom));\n  position: fixed;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: 100;\n}\n.bottom-nav__item {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 3px;\n  padding: var(--s-2) 0;\n  text-decoration: none;\n  color: var(--c-text-faint);\n  font-size: 10px;\n  font-weight: 500;\n  transition: color var(--t-fast);\n}\n.bottom-nav__item--active {\n  color: var(--c-accent);\n}\n/*# sourceMappingURL=bottom-nav.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
var AppShellComponent = class _AppShellComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppShellComponent, selectors: [["cm-app-shell"]], decls: 7, vars: 0, consts: [[1, "shell"], [1, "shell__sidebar"], [1, "shell__main"], [1, "shell__bottom-nav"]], template: function AppShellComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0);
        \u0275\u0275element(1, "cm-app-header")(2, "cm-sidebar", 1);
        \u0275\u0275elementStart(3, "main", 2);
        \u0275\u0275element(4, "router-outlet");
        \u0275\u0275elementEnd();
        \u0275\u0275element(5, "cm-bottom-nav", 3)(6, "p-toast");
        \u0275\u0275elementEnd();
      }
    }, dependencies: [RouterOutlet, SidebarComponent, BottomNavComponent, ToastModule, Toast, AppHeaderComponent], styles: ["\n.shell[_ngcontent-%COMP%] {\n  display: flex;\n  height: 100dvh;\n  background: var(--c-bg);\n}\n.shell__sidebar[_ngcontent-%COMP%] {\n  display: none;\n}\n@media (min-width: 900px) {\n  .shell__sidebar[_ngcontent-%COMP%] {\n    display: flex;\n  }\n}\n.shell__main[_ngcontent-%COMP%] {\n  flex: 1;\n  overflow-y: auto;\n  overflow-x: hidden;\n  -webkit-overflow-scrolling: touch;\n}\n.shell__bottom-nav[_ngcontent-%COMP%] {\n  display: flex;\n}\n@media (min-width: 900px) {\n  .shell__bottom-nav[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n@media (max-width: 899px) {\n  .shell[_ngcontent-%COMP%] {\n    flex-direction: column;\n  }\n  .shell__main[_ngcontent-%COMP%] {\n    padding-bottom: 72px;\n  }\n}\n/*# sourceMappingURL=app-shell.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppShellComponent, [{
    type: Component,
    args: [{ selector: "cm-app-shell", standalone: true, imports: [RouterOutlet, SidebarComponent, BottomNavComponent, ToastModule, AppHeaderComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: `
    <div class="shell">
  ...
  `, styles: ["/* apps/porteiro/src/app/layout/app-shell/app-shell.component.css */\n.shell {\n  display: flex;\n  height: 100dvh;\n  background: var(--c-bg);\n}\n.shell__sidebar {\n  display: none;\n}\n@media (min-width: 900px) {\n  .shell__sidebar {\n    display: flex;\n  }\n}\n.shell__main {\n  flex: 1;\n  overflow-y: auto;\n  overflow-x: hidden;\n  -webkit-overflow-scrolling: touch;\n}\n.shell__bottom-nav {\n  display: flex;\n}\n@media (min-width: 900px) {\n  .shell__bottom-nav {\n    display: none;\n  }\n}\n@media (max-width: 899px) {\n  .shell {\n    flex-direction: column;\n  }\n  .shell__main {\n    padding-bottom: 72px;\n  }\n}\n/*# sourceMappingURL=app-shell.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppShellComponent, { className: "AppShellComponent", filePath: "apps/porteiro/src/app/layout/app-shell/app-shell.component.ts", lineNumber: 26 });
})();

export {
  AppShellComponent
};
//# sourceMappingURL=chunk-2QRHUBL3.js.map
