...
function AnnouncementsComponent_Conditional_3_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, AnnouncementsComponent_Conditional_3_For_2_Conditional_6_Template, 2, 0, "cm-badge", 10);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("--priority-color", ctx_r1.priorityColor(a_r1.priority));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(a_r1.title);
    \u0275\u0275advance();
    \u0275\u0275conditional(a_r1.pinned ? 6 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.body);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind2(11, 6, a_r1.publishedAt, "dd/MM/yyyy"));
  }
}
...
var AnnouncementsComponent = class _AnnouncementsComponent {
  constructor() {
    this.announcements = signal([
      { id: "1", title: "Manuten\xE7\xE3o elevador", body: "O elevador ficar\xE1 inativo no s\xE1bado das 8h \xE0s 17h.", priority: "alta", pinned: true, publishedAt: "2026-04-20T08:00:00" },
      { id: "2", title: "Reuni\xE3o de condom\xEDnio", body: "Pr\xF3xima reuni\xE3o no dia 25/04 \xE0s 19h no sal\xE3o.", priority: "media", pinned: false, publishedAt: "2026-04-18T10:00:00" },
      { id: "3", title: "Coleta seletiva", body: "A coleta seletiva acontece toda ter\xE7a-feira.", priority: "baixa", pinned: false, publishedAt: "2026-04-15T09:00:00" }
    ]);
  }
  priorityColor(p) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AnnouncementsComponent, selectors: [["cm-announcements"]], decls: 4, vars: 1, consts: [[1, "announcements-page"], ["title", "Avisos", "eyebrow", "COMUNICADOS"], ["icon", "\u{1F4CB}", "title", "Sem avisos", "subtitle", "Nenhum comunicado publicado"], [1, "aviso-list"], [1, "aviso-card", 3, "--priority-color"], [1, "aviso-card"], [1, "aviso-bar"], [1, "aviso-body"], [1, "aviso-header"], [1, "aviso-title"], ["variant", "neutral"], [1, "aviso-text"], [1, "aviso-date"]], template: function AnnouncementsComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275template(2, AnnouncementsComponent_Conditional_2_Template, 1, 0, "cm-empty-state", 2)(3, AnnouncementsComponent_Conditional_3_Template, 3, 0, "div", 3);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
